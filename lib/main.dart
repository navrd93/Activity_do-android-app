...
class TaskProvider extends ChangeNotifier {
  ...
  void toggleTaskCompletion(Task t) {
    if (t.recurring != 'none') {
      // Create a copy representing today's completed occurrence.
      Task completedRecord = Task(
        text: t.text,
        id: DateTime.now().millisecondsSinceEpoch.toString(), // new unique id for record
        completed: true,
        priority: t.priority,
        category: t.category,
        dueDate: t.dueDate, // record today's due date
        dueTime: t.dueTime,
      ...
      // Now update the recurring task's due date to next occurrence.
...
/// The widget has been updated so that all activity emojies are visible within the inner rectangle
/// with proper spacing between them and without requiring swiping.
...
class _StatsDialogState extends State<StatsDialog> {
  String filterOption = "Daily"; // default filter option

  // Predefined colors for activities. You can extend or modify these.
  ...
  // This function filters completed tasks based on the selected filter.
  ...
  Widget build(BuildContext context) {
    ...
    // Group counts by activity category.
    ...
    // Filter activities to only those with count > 0.
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Outer horizontal rectangle with rounded corners and faded transparent background.
            Container(
              ...
              child: Container(
                ...
                // Using a Row with Expanded children ensures all activities are visible within the rectangle.
                child: activeActivities.isEmpty
                    ...
                    : Row(
                        ...
                        children: activeActivities.map((activity) {
                          ...
                          // Determine bar height. Cap at maxBarHeight for counts >= 10.
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    provider.activityCategories[activity] ?? "", 
...
/// Tapping it expands into a dynamic pill showing additional icons:
/// stats, calendar, and a quick note icon.
...
class _DynamicIslandWidgetState extends State<DynamicIslandWidget>
  ...
  void _openCalendarDialog() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => const FullCalendarModal()),
    );
  }

  void _openQuickNoteDialog() {
    // Open the quick note dialog with persistent storage.
    showDialog(
      context: context,
...
class _QuickNoteDialogState extends State<QuickNoteDialog>
  ...
  void _saveNote() {
    if (_noteController.text.trim().isNotEmpty &&
        _wordCount(_noteController.text) <= 5000) {
      setState(() {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                trailing: IconButton(
                                  ...
                                  onPressed: () => _deleteNoteFromList(index),
                                ),
...
/// SavedNotesScreen displays all the saved notes in a scrollable list.
...
class TodoApp extends StatefulWidget {
  ...
  const TodoApp({Key? key, required this.isDark, required this.savedThemeName})
      : super(key: key);
  @override
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (_) =>
                ThemeNotifier(isDark: widget.isDark, themeName: widget.savedThemeName)),
      ],
...
/// HomeScreen displays header, tasks, and includes the DynamicIslandWidget.
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _showAddActivityModal() {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => const AddActivitySheet()));
  }

  void _showFilterOptions() {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => const FilterOptionsSheet()));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text(''),
          flexibleSpace: const UserHeader(),
        ),
        body: Stack(
          children: [
            Column(
                            ...
                            onChanged: (val) async {
                              ...
                              if (val) {
                                await Navigator.of(context).push(
                                  MaterialPageRoute(builder: (_) => const CompletedActivitiesScreen()),
                                );
            ...
            Positioned(
              bottom: 16,
              left: 20,
              child: DynamicIslandWidget(key: _dynamicIslandKey),
            ),
          ],
        ),
...
class UserHeader extends StatelessWidget {
  ...
  void _showProfileSettings(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => const ProfileSettingSheet(),
    ));
  }
  ...
  Widget build(BuildContext context) {
    ...
    final headerColor = themeNotifier.isDark
        ? darkThemeColors[themeNotifier.themeName]!
        : lightThemeColors[themeNotifier.themeName]!;
...
class TaskOccurrencesView extends StatelessWidget {
  ...
  void _showSortOptions(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => const SortOptionsSheet()));
  }

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<TaskProvider>(context);
    List<TaskOccurrence> occurrences = provider.getUniqueTaskOccurrences();
    occurrences = occurrences.where((occ) => !occ.task.completed).toList();
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.all(16),
          ...
          child: occurrences.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String emoji = Provider.of<TaskProvider>(context, listen: false)
                            .activityCategories[occ.task.category] ??
                        '';
                            ...
                            child: Row(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) => EditActivitySheet(task: occ.task),
                                    ));
                                  },
                                ),
                                IconButton(
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: _selectedCategory == activity ? Colors.deepPurple : Colors.transparent,
                width: 2,
              ),
            ),
            child: Column(
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: OutlinedButton(
                        onPressed: _pickTime, 
                        child: Text(timeStr.isEmpty ? 'Select Time' : 'Time: $timeStr')
                      )
                    ),
                  ]
                ),
...
class _EditActivitySheetState extends State<EditActivitySheet> {
  ...
  void initState() {
    ...
    _selectedTime = widget.task.dueTime.isNotEmpty 
        ? TimeOfDay.fromDateTime(DateTime.tryParse("2000-01-01 ${widget.task.dueTime}") ?? DateTime.now()) 
        : null;
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(Provider.of<TaskProvider>(context, listen: false).activityCategories[activity] ?? "",
        ...
        child: Column(
          children: [
            ...
            AspectRatio(
              ...
              child: Consumer<TaskProvider>(
                builder: (context, taskProvider, child) {
                  List<TaskOccurrence> activeOccurrences = taskProvider
                      .getUniqueTaskOccurrences()
                      .where((occ) => !occ.task.completed)
                      .toList();
                  return TableCalendar(
                    ...
                    eventLoader: (day) {
                      return activeOccurrences
                          .where((occurrence) => isSameDay(occurrence.occurrenceDate, day))
                          .toList();
                    },
                    ...
                    headerStyle: HeaderStyle(
                      ...
                      titleCentered: true,
                      titleTextStyle: TextStyle(color: headerTextColor, fontSize: 16),
                    ),
                  );
                },
              ),
            ...
            Expanded(
              child: Consumer<TaskProvider>(
                builder: (context, taskProvider, child) {
                  List<TaskOccurrence> eventsForSelectedDay = taskProvider
                      .getUniqueTaskOccurrences()
                      .where((occurrence) =>
                          !occurrence.task.completed &&
                          isSameDay(occurrence.occurrenceDate, _selectedDay))
                      .toList();
                  if (eventsForSelectedDay.isEmpty) {
                    return const Center(
                      child: Text("No activities on this day", style: TextStyle(fontSize: 16)),
                    );
                  }
                  return Container(
                    width: double.infinity,
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String timeLabel = occ.task.dueTime.isNotEmpty
                            ? "Due: ${occ.task.dueTime}"
                            : "";
            ...
            ElevatedButton(
              ...
              child: const Text('Close Calendar'),
            ),
          ],
        ),
      ),
...
/// ProfileSettingSheet allows changing profile settings.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: _selectedEmoji == emoji ? Colors.amber : Colors.grey,
                          width: 2,
                        ),
                      ),
              ...
              SizedBox(
                width: double.infinity,
                child: ElevatedButton(onPressed: _saveProfile, child: const Text('Save Profile')),
              ),
            ],
          ),
        ),
...
/// ThemeSettingsSheet allows changing theme settings.
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: themeNotifier.themeName == themeKey ? Colors.white : Colors.transparent,
                          width: 2,
                        ),
                      ),
                    ),
